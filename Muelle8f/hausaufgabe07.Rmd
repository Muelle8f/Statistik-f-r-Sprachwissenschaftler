...
Es gibt eine geringere Prozentzahl (also Anzahl) ausgezeichneter Noten im Vergleich zu schlechten Noten. 

Warum?

Als ausgezeichnete Noten wurden alle Noten >= 13 Punkte definiert, also 13, 14 und 15. 
Als schlechte Noten wurden hingegen alle Noten <5 Punkte definiert, also 4, 3, 2, 1. 
Der definierte Bereich schlechter Noten ist damit größer als der definierte Bereich ausgezeichneter Noten. In den größeren Bereich fallen mehr Prozent, wodurch der Bereich schlechter Noten eine höhere Prozentzahl aufweist. 
...
Die Verteilung ist linksschief, da sich der Gipfel auf der rechten Seite befindet. 
...
## Von Perzentilen auf Häufigkeiten
...
Bei diesem Dozenten ist die Verwaltung wirklich unsicher, ob und was für einen Unterschied es geben könnte. (Welche Testart sollte man hier nutzen? Überlegung: Einen zweiseitigen Test.)
...
Das ist ein **insignifikanter** Unterschied, da z = 1,764 < 1,88 (kritischer Wert des zweiseitigen Tests). 
...
Das ist ein **signifikanter** Unterschied, da z = 4.714 > 1,88.  

Ist die Benotung vom Dozenten weniger als ideal? 

### Ein anderer, böserer? Dozent
Die Verwaltung ist auch auf einen anderen Dozenten aufmerksam geworden, weil manche Studenten behaupten, er würde zu streng benoten. (Welche Testart sollte man hier nutzen? Überlegung: Einen einseitigen Test.)
...
Das ist ein **insignifikanter** Unterschied, da |1,49| < 1,55 (kritischer Wert des einseitigen Tests).    
