...
Wenn wir naiv die Wiederholungen betrachten, können wir uns entweder auf den zufälligen Faktor **Subject** oder den zufälligen Faktor **Item** dadurch konzentriren, dass wir die Mittelwerte berechnen. 
...
Antwort: Ich kann nicht sagen welches Format am meisten Sinn macht. Allerdings finde ich die erste Darstellungsart (Versuchspersonen als Zeilen und Bedingungen als Spalten) am übersichtlichsten. Aus diesem Grund würde ich mich wahrscheinlich für diese Art der Darstellung entscheiden.   
...
Antwort: Dies hängt sicherlich davon ab, was genau man sich anhand der Plots anschauen oder was man darstellen möchte. Möchte ich beispielsweise eine visuelle Analyse der Normalverteilung und Varianz durchführen, eignet sich hierfür wohl die Dichteverteilung am besten. 
...
Antwort: Nein, die Daten by Subject und by Item sehen nicht gleich aus. Im Vergleich zu den Single-Trial-Daten sehen sie weniger normal verteilt und weniger homogen aus. 
...
Oder die zweite Darstellungsart:
```{r, results='asis'}
